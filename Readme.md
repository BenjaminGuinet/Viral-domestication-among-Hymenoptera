...
- **/beegfs/data/bguinet/these/Repeat_env_analysis2/BlastX_BUSCO_and_EVEs_on_RepeatPeps_results_{sp_names}.tab** (the blast result for each species loci against RepeatPeps db). 
